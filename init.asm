...
main(void)
{
  ...
  printf(1, "1. Rastin Soraki\n");
  3f:	58                   	pop    %eax
  40:	5a                   	pop    %edx
  41:	68 40 08 00 00       	push   $0x840
  46:	6a 01                	push   $0x1
  48:	e8 93 04 00 00       	call   4e0 <printf>
  printf(1, "2. Habib Ghadimi\n");
  4d:	59                   	pop    %ecx
  4e:	5b                   	pop    %ebx
  4f:	68 52 08 00 00       	push   $0x852
  54:	6a 01                	push   $0x1
  56:	e8 85 04 00 00       	call   4e0 <printf>
  printf(1, "3. Mohammad Saeed Safari\n");
  5b:	58                   	pop    %eax
  5c:	5a                   	pop    %edx
  5d:	68 64 08 00 00       	push   $0x864
  62:	6a 01                	push   $0x1
  ...
  a0:	68 bd 08 00 00       	push   $0x8bd
  a5:	6a 01                	push   $0x1
  a7:	e8 34 04 00 00       	call   4e0 <printf>
  ac:	83 c4 10             	add    $0x10,%esp
  af:	eb df                	jmp    90 <main+0x90>
      printf(1, "init: fork failed\n");
  b1:	53                   	push   %ebx
  b2:	53                   	push   %ebx
  b3:	68 91 08 00 00       	push   $0x891
  b8:	6a 01                	push   $0x1
 ...
 449:	85 d2                	test   %edx,%edx
{
 ...
 477:	f7 f1                	div    %ecx
 479:	0f b6 92 d0 08 00 00 	movzbl 0x8d0(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 694:	e9 8f fe ff ff       	jmp    528 <printf+0x48>
          s = "(null)";
 699:	bb c6 08 00 00       	mov    $0x8c6,%ebx
        while(*s != 0){
 ...
 6b1:	a1 80 0b 00 00       	mov    0xb80,%eax
{
 ...
 6ed:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6ef:	a3 80 0b 00 00       	mov    %eax,0xb80
}
 6f4:	5b                   	pop    %ebx
 6f5:	5e                   	pop    %esi
 6f6:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 78f:	73 47                	jae    7d8 <malloc+0x98>
    ...
    if(p == freep)
 791:	39 05 80 0b 00 00    	cmp    %eax,0xb80
 ...
 7b6:	e8 f5 fe ff ff       	call   6b0 <free>
  return freep;
 7bb:	8b 15 80 0b 00 00    	mov    0xb80,%edx
 ...
 7e4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7e7:	89 15 80 0b 00 00    	mov    %edx,0xb80
}
 ...
 807:	0b 00 00 
 80a:	c7 05 84 0b 00 00 84 	movl   $0xb84,0xb84
 811:	0b 00 00 
    base.s.size = 0;
 814:	b8 84 0b 00 00       	mov    $0xb84,%eax
