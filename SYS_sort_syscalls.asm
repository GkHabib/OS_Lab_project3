...
_SYS_sort_syscalls:     file format elf32-i386
...
int main(int argc, char const *argv[])
{
  ...
  1f:	e8 06 03 00 00       	call   32a <sort_syscalls>
    return 0;
}
